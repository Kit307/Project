<template>
  <div class="h-screen dark:bg-gray-700 lg:pt-24 md:pt-16">
    <div
      class="container px-5 py-24 mx-auto dark:bg-gray-700 dark:text-white"
      style="cursor: auto"
    >
      <div class="lg:w-4/5 mx-auto flex flex-wrap">
        ...
        />
        <div
          class="lg:w-1/2 w-full lg:pl-10 lg:py-6 md:mt-6 lg:mt-0 dark:bg-gray-800 rounded-lg px-5"
          style="cursor: auto"
        >
          <h2
          ...
          <div class="flex mb-4">
            <span class="flex items-center">
              ...
              <span class="text-gray-600 ml-3 dark:text-white">20 Reviews</span>
            </span>
          </div>
